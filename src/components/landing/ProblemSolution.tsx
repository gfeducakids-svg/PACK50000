    ...
    <section className="w-full py-20 md:py-28 lg:py-32 bg-background">
      <div className="container px-4 md:px-6">
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-20 items-center">
          ...
          <div className="space-y-6 rounded-xl bg-primary/5 p-8 border border-primary/10 shadow-lg">
             <div className="flex items-center gap-3">
            ...
            <div className="flex items-start gap-4 rounded-md bg-background p-4 border">
